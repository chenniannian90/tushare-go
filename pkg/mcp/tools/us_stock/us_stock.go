...
func (m *Us_stockTools) ListTools() []common.Tool {
	return []common.Tool{
		...
		{
			Name: "us_stock.us_cal",
			Description: "Access us_cal data from Tushare API",
		},
		{
		...
		{
			Name: "us_stock.us_factor",
			Description: "Access us_factor data from Tushare API",
		},
		{
