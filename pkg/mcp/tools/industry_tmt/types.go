...
type BoCinemaOutput struct {
	Data  []industry_tmt.BoCinemaItem `json:"data" jsonschema:"bo_cinema data list"`
...
type BoDailyOutput struct {
	Data  []industry_tmt.BoDailyItem `json:"data" jsonschema:"bo_daily data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
...
type BoMonthlyOutput struct {
	Data  []industry_tmt.BoMonthlyItem `json:"data" jsonschema:"bo_monthly data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
...
type BoWeeklyOutput struct {
	Data  []industry_tmt.BoWeeklyItem `json:"data" jsonschema:"bo_weekly data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
...
type FilmRecordOutput struct {
	Data  []industry_tmt.FilmRecordItem `json:"data" jsonschema:"film_record data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
...
type TeleplayRecordOutput struct {
	Data  []industry_tmt.TeleplayRecordItem `json:"data" jsonschema:"teleplay_record data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
...
type TmtTwincomeOutput struct {
	Data  []industry_tmt.TmtTwincomeItem `json:"data" jsonschema:"tmt_twincome data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
...
type TmtTwincomedetailOutput struct {
	Data  []industry_tmt.TmtTwincomedetailItem `json:"data" jsonschema:"tmt_twincomedetail data list"`
	Total int              `json:"total" jsonschema:"Total count"`
}
